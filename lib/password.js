...
exports.validatePassword = exports.hashPassword = exports.generatePassword = exports.generateCharset = void 0;
...
exports.generateCharset = generateCharset;
/**
 * @param {string} length
...
var generatePassword = function (length, useUpper, useNumber, useSpecial) {
    var charset = (0, exports.generateCharset)(useUpper, useNumber, useSpecial);
    var pswd = '';
